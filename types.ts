...
export type ViewName = 'dashboard' | 'new-quote' | 'lead-intel' | 'market-trends' | 'data-miner' | 'price-comparison' | 'contacts' | 'ai-tools' | 'products' | 'admin' | 'campaigns' | 'intelligent-sales-hub' | 'lead-dossier' | 'supervisor' | 'visualizer' | 'sales-intel-center' | 'roofing-estimator';
...
export interface Lead {
  ...
  summary: string;
  projectType: string;
  projectStage: 'Planning' | 'Approved' | 'Pre-Construction' | 'On-Site' | 'Complete' | 'Unknown' | 'Withdrawn' | 'Rejected' | 'Awaiting Decision' | 'Granted Conditionally' | 'Pre-Planning' | 'Overdue / Stalled' | 'Watchlist' | 'Stalled';
...
export interface PlanReaderResult {
  ...
  project_details?: {
    ...
    scale_audit?: {
      ...
      pixel_length: number;
      px_per_meter: number;
      method: 'Explicit Text Match' | 'Visual Estimation' | 'Manual Calibration';
    };
  };
