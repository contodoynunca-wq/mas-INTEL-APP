                ...
                <div className="space-y-6">
                    <div>
                        ...
                        {lead.geolocation ? (
                            ...
                            <>
                                <div className="no-print p-4 bg-surface text-center rounded-lg text-text-secondary text-sm mb-2">
                                    Interactive Map Unavailable (Missing Coordinates)
                                </div>
                                <div className="print-only">
                                    {/* Fallback to address-based static map */}
                                    <StaticMap address={lead.address || lead.council || ''} />
                                </div>
                            </>
                        )}
                         <div className="flex flex-col gap-2 mt-4 no-print">
                            {lead.geolocation ? (
                                ...
                                <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(lead.address || '')}`} target="_blank" rel="noopener noreferrer" className="btn tertiary w-full">Search Address on Google Maps</a>
                            )}
                        </div>
                    </div>
                     <div className="no-print">
